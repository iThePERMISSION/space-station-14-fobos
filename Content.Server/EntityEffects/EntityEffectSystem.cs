...
public sealed class EntityEffectSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ExecuteEntityEffectEvent<InfectionDamage>>(OnInfectionDamage);
        // DS14-end
    }
    ...
    private void OnInfectionDamage(ref ExecuteEntityEffectEvent<InfectionDamage> args)
    {
